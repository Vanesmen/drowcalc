...
let sliceTwo_demensional = (two_dimensional, widthTurn, propX) => {
    let two_dimensional_B = [];
    while (calcTotalLengthSystem(two_dimensional, widthTurn, propX) > 85000) { // Максимальная длинна 84м + 1м погрешность
